                        ...
                        <div>
                            ...
                            <div className={style.mainBlock1}>
                                <div className={style.mainContentDiv}>
                                    ...
                                    <div className={style.wrapperMainBlock1}>
                                        <img src="/logo_umma.png" style={{height: "300px"}} alt="Logo"/>
                                        <div className={style.wrapperMainBlock1Titles}>
                                            <p style={{marginRight: '15px'}}>
                                                История. Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                                                Beatae
                                                facere
                                                laboriosam similique
                                                minus voluptatibus nesciunt ducimus qui fuga molestias sed. Corrupti,
                                                quod
                                                accusamus.
                                                Quia adipisci ab
                                            ...
                                            <p>
                                                Причина. Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                                                Beatae
                                                facere
                                                laboriosam similique
                                                minus voluptatibus nesciunt ducimus qui fuga molestias sed. Corrupti,
                            ...
                            <div className={style.mainContentDiv}>
                                ...
                                <div className={style.mainBlock2}>
                                    ...
                                    <h3>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio blanditiis
                                        pariatur
                                        earum
                                        distinctio unde
                                        dolor velit, nihil exercitationem autem cumque aut! Assumenda eum earum magnam
                                        animi
                                        officiis excepturi,
                                    ...
                                    >
                                        <ModalContent>
                                            {(onClose) => (
                                                <>
                                                    <ModalHeader className="flex flex-col gap-1">Modal
                                                        Title</ModalHeader>
                                                    <ModalBody>
                                                        <p>
                                    ...
                                    <div className={style.accordions}>
                                        <div className={style.accordion}>
                                            ...
                                            <div className={style.text}>
                                                ...
                                                nostrum
                                                quaerat repellat
                                                excepturi obcaecati consequuntur incidunt odit quisquam fuga
                                                reprehenderit
                                                maiores,
                                                possimus ullam,
                                        ...
                                        <div className={style.accordion}>
                                            ...
                                            <div className={style.text}>
                                                ...
                                                a, omnis voluptas esse ad, accusantium facere nam. Blanditiis cupiditate
                                                quam
                                                veniam
                                                est. Voluptas,
                                                similique at?
                                        ...
                                        <div className={style.accordion}>
                                            ...
                                            <div className={style.text}>
                                                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Amet unde iure
                                                eveniet
                                                vitae ex, cum
                                                cumque nihil! Reprehenderit ipsam qui repudiandae temporibus rem, et
                                                sint a
                                                quaerat
                                                aut quos cum?
                                            </div>
                                        ...
                                        <div className={style.accordion}>
                                            ...
                                            <div className={style.text}>
                                                ...
                                                optio
                                                quis, nisi hic
                                                perspiciatis maiores cum rem aliquid ea molestias sint non incidunt
                                                veritatis
                                                eius
                                                blanditiis error
                                                fugiat!
